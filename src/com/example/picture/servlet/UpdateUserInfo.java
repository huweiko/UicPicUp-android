...
public class UpdateUserInfo {
	private String URL="http://srcer.com/mydemo/selpic/upduser.php";
	private String result="";
	public String doPost(String email,String name){
		...
		System.out.println("doPost UpdUserInfo ret[" + result + "]");
		return result; 
	}
}
